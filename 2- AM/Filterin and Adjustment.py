...
class ExerciseA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ExerciseA")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 0.10, 0.001, 0.05, 200)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:/Users/Studente/Desktop/sogand/4/am_usrp710.dat', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate/self.resamp_factor, 5000, 100, firdes.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=ExerciseA, options=None):
