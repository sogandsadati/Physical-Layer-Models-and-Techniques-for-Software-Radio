...
class session5partE(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "session5partE")
        ...
        # Blocks
        ##################################################
        self._noise_volt_range = Range(0, 1, 0.001, 0.0001, 200)
        ...
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(2, 0.001, rrc_taps, 32, 16, 1.5, 1)
...
def main(top_block_cls=session5partE, options=None):
