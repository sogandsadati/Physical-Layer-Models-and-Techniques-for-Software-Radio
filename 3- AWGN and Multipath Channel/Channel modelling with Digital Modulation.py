...
class session5partD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "session5partD")
        ...
        # Blocks
        ##################################################
        self._amp_range = Range(0, 10, 1, 10, 200)
...
def main(top_block_cls=session5partD, options=None):
